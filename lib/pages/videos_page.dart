...
//   final String apiKey = "AIzaSyADCcTavboWPc_o7d4cDphLIGjJi43eIYk";
...
//
//   // String nextPageToken = ''; // Used for pagination
//   late String nextPageTokenMedium;
//   late String nextPageTokenLong;
//
...
//     nextPageTokenMedium = '';
//     nextPageTokenLong = '';
//     _loadVideos(nextPageTokenMedium, nextPageTokenLong);
//   }
//
//   Future<void> _loadVideos(String nextPageTokenMedium, String nextPageTokenLong) async {
//     setState(() {
//       isLoading = true;
//     });
//
//     await _loadAndCombineVideos("medium", nextPageTokenMedium);
//     await _loadAndCombineVideos("long", nextPageTokenLong);
//
//     setState(() {
//       isError = false;
//       isLoading = false;
...
//   }
//
//   Future<void> _loadAndCombineVideos(String videoDuration, String nextPageToken) async {
//     String updatedToken = await _loadVideosByDuration(videoDuration, nextPageToken);
//
//     if (videoDuration == "medium") {
//       nextPageTokenMedium = updatedToken;
//     } else if (videoDuration == "long") {
//       nextPageTokenLong = updatedToken;
//     }
//   }
//
...
//     String params =
//         "?part=snippet&channelId=$channelId&type=video&videoType=any&videoDuration=$videoDuration&order=date&maxResults=$maxResults&pageToken=$nextPageToken&key=$apiKey&publishedAfter=$publishedAfter";
//
...
//             newVideos.add(YoutubeModel.fromJson(item));
//           }
//
//           String updatedNextPageToken =
//           data.containsKey('nextPageToken') ? data['nextPageToken'] : '';
//
//           List<YoutubeModel> combinedVideos = (videos + newVideos).toList();
//           Set<String> videoIds = Set<String>();
//           List<YoutubeModel> uniqueVideos = [];
//
//           for (var video in combinedVideos) {
//             if (!videoIds.contains(video.id.videoId)) {
...
//
//           videos = uniqueVideos;
//           videos.sort((a, b) => b.snippet!.publishedAt!.compareTo(a.snippet!.publishedAt!));
//
//           setState(() {
//             isError = false;
//             isLoading = false;
...
//     if (!isLoading) {
//       await _loadVideos(nextPageTokenMedium, nextPageTokenLong);
//     }
//   }
//
//   void _scrollListener() {
//     if (_scrollController.position.pixels >= _scrollController.position.maxScrollExtent - 400.0) {
//       // You can adjust the value (200.0) based on your needs
